...
| 8.24 | Cifrado en tránsito | Implementado | TLS con Atlas; HTTPS del navegador a Netlify y de Netlify a Render (HSTS en `netlify.toml`) | `farmacentro-backend/src/config/db.ts`, `Farmacentro-Frontend/netlify.toml`, `render.yaml` | 1, 4 | R04, R05 |
