...
| **D-06** | Servidor de correo | **Resuelta (25/09/2026):** en desarrollo `MAIL_TRANSPORT=console` muestra los correos en la terminal del backend (solo permitido con `NODE_ENV=development`). Fuera de desarrollo se exige un SMTP real. | ¿Qué SMTP real se usará en el despliegue? |
